## moveit_resources (noetic) - 0.8.2-1

The packages in the `moveit_resources` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic moveit_resources` on `Thu, 18 Nov 2021 20:17:41 -0000`
...
## moveit_resources (noetic) - 0.8.1-1

The packages in the `moveit_resources` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic moveit_resources` on `Sat, 06 Nov 2021 14:29:45 -0000`
...
## moveit_resources (melodic) - 0.7.3-1

The packages in the `moveit_resources` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --ros-distro melodic moveit_resources -e` on `Mon, 03 May 2021 08:58:58 -0000`
...
## moveit_resources (noetic) - 0.8.0-1

The packages in the `moveit_resources` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic moveit_resources` on `Mon, 03 May 2021 08:46:37 -0000`
...
## moveit_resources (noetic) - 0.7.2-1

The packages in the `moveit_resources` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic moveit_resources` on `Mon, 29 Mar 2021 07:16:49 -0000`
...
## moveit_resources (melodic) - 0.7.2-1

The packages in the `moveit_resources` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --ros-distro melodic moveit_resources` on `Mon, 29 Mar 2021 07:05:37 -0000`
...
## moveit_resources (noetic) - 0.7.1-1

The packages in the `moveit_resources` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic moveit_resources` on `Fri, 09 Oct 2020 17:19:48 -0000`
...
## moveit_resources (kinetic) - 0.6.5-1

The packages in the `moveit_resources` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release moveit_resources --rosdistro kinetic` on `Tue, 18 Feb 2020 15:28:30 -0000`
